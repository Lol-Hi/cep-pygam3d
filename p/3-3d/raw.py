...
def cuboid(screen, corner1, corner2, state):
    # corner1 = (15, 3, 7)
    # corner2 = (18, 0, 2)
    ...
    if posX == -1 and posY == -1:
        pygame.draw.polygon(screen, BLUE, faceRight)
        pygame.draw.polygon(screen, GREEN, faceFront)
        pygame.draw.polygon(screen, BLACK, faceBottom)
    elif posX == 1 and posY == -1:
        pygame.draw.polygon(screen, BLUE, faceLeft)
        pygame.draw.polygon(screen, GREEN, faceFront)
        pygame.draw.polygon(screen, BLACK, faceBottom)
    elif posX == 1 and posY == 1:
        pygame.draw.polygon(screen, BLUE, faceLeft)
        pygame.draw.polygon(screen, GREEN, faceFront)
        pygame.draw.polygon(screen, BLACK, faceTop)
    elif posX == -1 and posY == 1:
        pygame.draw.polygon(screen, BLUE, faceRight)
        pygame.draw.polygon(screen, GREEN, faceFront)
        pygame.draw.polygon(screen, BLACK, faceTop)
    ...
    # pygame.draw.polygon(screen, RED, [verticeA, verticeB, verticeC, verticeD])
    # pygame.draw.polygon(screen, GREEN, [verticeA, verticeD, verticeH, verticeE])
    # pygame.draw.polygon(screen, BLUE, [verticeA, verticeB, verticeF, verticeE])
    # pygame.draw.polygon(screen, BLACK, [verticeE, verticeF, verticeG, verticeH])
